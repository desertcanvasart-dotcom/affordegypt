...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Reference-data CRUD: cities, add-ons, attractions, vehicle-types,
  // guide-rates (extracted to ./routes/reference-data.ts)
  ...
  // (duplicate GET /api/attractions removed — shadowed by the translated
  // version; GET /api/attractions/:id moved to ./routes/reference-data.ts)
